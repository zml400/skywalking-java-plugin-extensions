...
public class DB2CallableInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String DS_CALLABLE_STATEMENT_CLASS = "com.ibm.db2.jcc.am.ds";
    public static final String DU_CALLABLE_STATEMENT_CLASS = "com.ibm.db2.jcc.am.du";
    ...
    @Override public InstanceMethodsInterceptPoint[] getInstanceMethodsInterceptPoints() {
        System.out.println("DB2CallableInstrumentation");
    ...
    @Override protected ClassMatch enhanceClass() {
        return MultiClassNameMatch.byMultiClassMatch(
                ...
                DS_CALLABLE_STATEMENT_CLASS,
                DU_CALLABLE_STATEMENT_CLASS,
                I_CALLABLE_STATEMENT_CLASS);
    }
}
