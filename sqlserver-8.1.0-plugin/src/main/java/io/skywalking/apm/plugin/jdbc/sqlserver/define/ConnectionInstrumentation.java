...
public class ConnectionInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String CONNECTION43_CLASS = "com.microsoft.sqlserver.jdbc.SQLServerConnection43";
    public static final String CONNECTIONPP_CLASS = "com.microsoft.sqlserver.jdbc.SQLServerConnectionPoolProxy";

    public static final String PREPARED_STATEMENT_INTERCEPT_CLASS = "io.skywalking.apm.plugin.jdbc.sqlserver.CreatePreparedStatementInterceptor";
    public static final String CALLABLE_INTERCEPT_CLASS = "io.skywalking.apm.plugin.jdbc.sqlserver.CreateCallableInterceptor";
    public static final String CREATE_STATEMENT_INTERCEPT_CLASS = "io.skywalking.apm.plugin.jdbc.sqlserver.CreateStatementInterceptor";
    ...
    @Override protected ClassMatch enhanceClass() {
        return MultiClassNameMatch.byMultiClassMatch(
                CONNECTION_CLASS,CONNECTION43_CLASS,CONNECTIONPP_CLASS);
    }
}
