...
import static io.skywalking.apm.plugin.jdbc.db2.v111.Constants.STATEMENT_INTERCEPT_CLASS;
...
public class DB2StatementInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String AG_STATEMENT_CLASS = "com.ibm.db2.jcc.am.ag";
    ...
    public static final String UP_STATEMENT_CLASS = "com.ibm.db2.jcc.am.up";
    public static final String VF_STATEMENT_CLASS = "com.ibm.db2.jcc.am.vf";
    public static final String VP_STATEMENT_CLASS = "com.ibm.db2.jcc.am.vp";
    public static final String WF_STATEMENT_CLASS = "com.ibm.db2.jcc.am.wf";
    public static final String XF_STATEMENT_CLASS = "com.ibm.db2.jcc.am.xf";
    public static final String ZF_STATEMENT_CLASS = "com.ibm.db2.jcc.am.zf";
