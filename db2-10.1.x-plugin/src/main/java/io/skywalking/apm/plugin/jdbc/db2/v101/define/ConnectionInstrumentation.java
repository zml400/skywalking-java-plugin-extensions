...
public class ConnectionInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    public static final String FF_CONNECTION_CLASS = "com.ibm.db2.jcc.am.ff";
    public static final String U_CONNECTION_CLASS = "com.ibm.db2.jcc.t2zos.u";

    public static final String PREPARED_STATEMENT_INTERCEPT_CLASS = "io.skywalking.apm.plugin.jdbc.db2.v101.CreatePreparedStatementInterceptor";
    public static final String CALLABLE_INTERCEPT_CLASS = "io.skywalking.apm.plugin.jdbc.db2.v101.CreateCallableInterceptor";
    public static final String CREATE_STATEMENT_INTERCEPT_CLASS = "io.skywalking.apm.plugin.jdbc.db2.v101.CreateStatementInterceptor";
